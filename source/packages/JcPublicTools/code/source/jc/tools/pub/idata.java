...

{
        ...
        throws ServiceException
	{
		...
		if ( doc != null)
		{
			...
			IData fnd = IDataUtil.getIData(c, key);
			c.destroy();
        ...
        throws ServiceException
	{
		...
		// [i] recref:1:required extraInfo jc.canonicals.eu.catalogue.common:ExtraInfo
		// [i] record:0:required doc
		// [o] record:0:required doc
		// pipeline in
		...
		if ( extraInfo != null && doc != null)
		{
			...
			for ( int i = 0; i < extraInfo.length; i++ )
			{
				...
				String value = IDataUtil.getString(extraInfoCursor, "value");
				...
				if (key != null && value != null && (prefix == null || key.startsWith(prefix)))
				{
					...
					{
						StringTokenizer tk = new StringTokenizer(value, valueTokenizer);
						List<String> out = new ArrayList<String>();
        ...
        throws ServiceException
	{
		...
		if (list1 != null) {
			...
			if (list2 != null) {
				...
				mergedList = new IData[list1.length + list2.length];
        ...
        throws ServiceException
	{
		...
		IData mergedDocument = null;
		
		if (doc2 != null) {
			mergedDocument = IDataUtil.clone(doc2);
