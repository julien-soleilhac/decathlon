        ...
        <tr>
		    ...
		    %comment%----- to support artconnjs.txt for multiple password fields -----%endcomment%
                    <input size=60
                               ...
                               value=""
                               onchange= "return passwordChanged(this.form, '%value -urlencode systemName%')" autocomplete="off"></input></td></tr>

                <script>writeTD('row');</script>Retype %value displayName%</td>
                <script>writeTD('rowdata-l'); swapRows();</script>
                <input size=60 type=password name="PWD.CPROP.%value -urlencode systemName%" value="" autocomplete="off"></input></td>
             %else%
                <script>writeTDspan('rowdata-l'); swapRows();</script>
