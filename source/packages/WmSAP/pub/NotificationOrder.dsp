            ...
            <tr>
                <td colspan=2>
                    <ul>
                        <li>
                        %ifvar readOnly equals('true')%
                            <a id="Return_to_View_Listener" href="ListenerDetails.dsp?%ifvar lt8%lt8=true&amp;%endif%readOnly=%value readOnly%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%&dspName=.LISTRESOURCES">
                                Return to View Listener
                            </a>
							<script>updateURL("Return_to_View_Listener", "Return to View Listener");</script>
                        %else%
                            <a id="Return_to_Edit_Listener" href="ListenerDetails.dsp?%ifvar lt8%lt8=true&amp;%endif%readOnly=%value readOnly%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%&dspName=.LISTRESOURCES">
